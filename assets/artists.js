...
export const artistList = [
  ...
  },
  {
    'name': 'Keota',
    'bio': 'BIO COMING SOON',
    'genre': 'Glitch/Halftime',
    'location': 'Brooklyn, NY',
    'picture': Images.keota,
    'link': 'https://soundcloud.com/keota-us'
  },
  {
    'name': 'Frameworks',
  ...
  {
    'name': 'Luke Mandala',
    'bio': 'Lukes deep passion with music was ignited at the age 14 with the open minded underground electronic scenes of 1998 - and that was the year he started to DJ. In 2007 Luke started releasing his own music and now has hundreds of songs released with a large number of the biggest labels in the world - Traum, Selador, Desert Hearts, Tulipa, Desert Trax, Merkaba Music, Addictech, Books Shade Music. With Lukes dynamic performances, depending on the crowd, you may encounter an eclectic mix of global sounds from the genres of techno/house, downtempo dance music, and chill out. The music is intentionally part of the massive movement of mind opening dance floors transforming the planet, and it has flown Luke to many continents around the planet to play music. It speaks to the heart and flows through intense emotive movements, flying through the cosmos or the deepest primal caves with a focus on play, inspiration, and unification.',
  ...
  {
    'name': 'Dot Diggler',
    'bio': 'Seattle breakbeat junkie. Founder of Fraktured, weekly broken beat night at Kremwerk.',
    'genre': 'Breaks',
    'location': 'Seattle, WA',
    'picture': Images.diggler,
    'link': 'https://soundcloud.com/dj-dot'
  },
  {
    'name': 'Brodyizm',
    'bio': 'Best heard at the witching hour, his music blends technicality with a delightfully dark twist. While sustained by low, deep basslines, a crisp, almost electrical current tears it’s melodic way through the fabric of sound.',
    'genre': 'Funk/Bass',
    'location': 'Salt Lake, UT',
    'picture': Images.brodyizm,
  ...
  },
  {
    ...
    'genre': 'Techno/Tech House',
    'location': 'Salt Lake, UT',
    'picture': Images.joshvolt,
    'link': 'https://soundcloud.com/josh-volt'
  },
  {
    'name': 'EvoluShawn',
    'bio': 'EvoluShawn has been creating music since 2009, his Influences come from hip hop to grimey bass music. He is always trying to expand his creativity through experimenting with different musical styles. In March, he shared the stage with Buku and Kowta with a set at Fatty’s Bar for the Treefort Music Festival in 2017, he plans to keep growing as an Artist and to always be evolving with his sound.',
    'genre': 'Bass Music',
